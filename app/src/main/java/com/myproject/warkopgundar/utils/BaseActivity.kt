...
open class BaseActivity: AppCompatActivity() {
    ...
    private fun performNavigation(intent: Intent, type: AnimType, isFinal: Boolean) {
        val options = when(type) {
            AnimType.FADE -> ActivityOptions.makeCustomAnimation(this, R.anim.fade_in, R.anim.fade_out)
            AnimType.SLIDE -> ActivityOptions.makeCustomAnimation(this, R.anim.slide_in_left, R.anim.slide_out_right)
            AnimType.NONE -> null
        }
    ...
    fun showDialogSuccess(title: String, message: String) {
        MaterialAlertDialogBuilder(this)
            .setTitle(title)
            .setMessage(message)
            .setIcon(com.myproject.warkopgundar.R.drawable.icon_status_success)
    ...
    fun showDialogError(title: String, message: String) {
        val dialog = MaterialAlertDialogBuilder(this)
            .setTitle(title)
            .setMessage(message)
            .setIcon(com.myproject.warkopgundar.R.drawable.icon_status_warning)
    ...
    fun replaceFragmentDashboard(containerId: Int, fragment: Fragment) {
        supportFragmentManager.beginTransaction()
            .setCustomAnimations(
                R.anim.fade_in, R.anim.fade_out, R.anim.slide_in_left,
